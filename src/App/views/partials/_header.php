  ...
  <header class="bg-orange-400">
    <nav class="mx-auto flex container items-center justify-between py-4" aria-label="Global">
      ...
      <div class="flex lg:gap-x-10">
        ...
        <a href="/login" class="text-black hover:text-white transition">Login</a>
        <a href="/register" class="text-black hover:text-white transition">Register</a>
        <a href="/logout" class="text-black hover:text-white transition">
